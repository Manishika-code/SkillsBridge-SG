...
export default function Dashboard(){  
    ...
    const populateCourseCards = [
        ...
        { id: 4, qualific:"Degree in", courseName:"Sociology", institution:"National University of Singapore", schoolCtg:"Department of Sociology", courseDesr:"Aims to equip students with essential business knowledge and specialised training in arts and social politics.", courseType:"Full-Time"},
    ]
